...
PROD_DOMAIN = "real-estate-backend-production-6330.up.railway.app"
...
SIMPLE_JWT = {
    ...
    'REFRESH_TOKEN_LIFETIME': timedelta(days=7),
    'ROTATE_REFRESH_TOKENS': False,  # Keep it False for now to avoid rotation bugs
    'BLACKLIST_AFTER_ROTATION': False,
    'ALGORITHM': 'HS256',
    'SIGNING_KEY': SECRET_KEY,
}

# Increase session age to avoid CSRF/Session timeouts
...
DEFAULT_FROM_EMAIL = os.environ.get("BREVO_SMTP_USER")
